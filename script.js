...
var scaleColor = d3.scale.linear().domain([300,100000]).range(['white','purple']);
//import data
...
queue()
    ...
    .await(function(err, blocks, neighbor,income) {
        ...
        draw(blocks, neighbor,income)

        console.log(blocks, neighbor)
    });
...
function attachTooltip(selection) {
    selection
        .on('mouseenter', function (d) {
            ...
            //tooltip.select('#name').html(d.properties.geoid);
        })
